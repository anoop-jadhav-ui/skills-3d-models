...
Command: npx gltfjsx@6.1.4 --types ./public/portfolio.glb --transform
*/
...
type GLTFResult = GLTF & {
  nodes: {
    ...
    randomCube1: THREE.Mesh;
    randomCube2: THREE.Mesh;
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        material={materials.GREY_METAL}
      />
      <mesh geometry={nodes.trackpad.geometry} material={materials.WHITE}>
        <mesh
      ...
      />
      <mesh geometry={nodes.notebook.geometry} material={materials.DARK_BLUE}>
        <mesh
      ...
      />
      <mesh geometry={nodes.monitor_3.geometry} material={materials.BLACK} />
      <mesh
        geometry={nodes.monitor_4.geometry}
        material={materials.MONITOR_TEXTURE}
      />
      <mesh geometry={nodes.monitor_5.geometry} material={materials.RED} />
      <mesh geometry={nodes.bulb_1.geometry} material={materials.YELLOW} />
      <mesh geometry={nodes.bulb_2.geometry} material={materials.DARK_BLUE} />
      <mesh geometry={nodes.pen_1.geometry} material={materials.BLACK} />
      <mesh geometry={nodes.pen_2.geometry} material={materials.RED} />
      <mesh geometry={nodes.pen_3.geometry} material={materials.WHITE} />
      <mesh geometry={nodes.textBlocks_1.geometry} material={materials.RED} />
      <mesh
        geometry={nodes.textBlocks_2.geometry}
        material={materials.MONITOR_TEXTURE}
      />
      <mesh geometry={nodes.dropper_1.geometry} material={materials.GLASS} />
      <mesh geometry={nodes.dropper_2.geometry} material={materials.ORANGE} />
      <mesh geometry={nodes.dropperFluid.geometry} material={materials.RED} />
      <mesh
        geometry={nodes.latteMug_1.geometry}
        material={materials.CUP_TEXTURE}
      />
      <mesh geometry={nodes.latteMug_2.geometry} material={materials.RED} />
    </group>
  );
}
